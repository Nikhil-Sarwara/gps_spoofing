...
if __name__ == "__main__":
    ...
    parser.add_argument("--artifacts-dir", default="Step_5_Data/artifacts", help="Artifacts directory")
    parser.add_argument("--models-dir", default="Step_5_Data/models", help="Models output directory")
